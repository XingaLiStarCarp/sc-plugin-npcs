package ba.entries.entity.npc.warfare.trait;
...
public class ArmyOfficerTrait extends MultiTrait {
	...
	public ArmyOfficerTrait(ItemStack gun) {
		super();
	...
	public ArmyOfficerTrait(String gun) {
		this(GunOperator.newGun(gun));
	}

	public ArmyOfficerTrait() {
