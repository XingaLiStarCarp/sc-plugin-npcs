...
import minecraft.codec.derived.DerivedCodecHolder;
import minecraft.datagen.EntryHolder;
import minecraft.datagen.annotation.RegistryEntry;
import minecraft.terrain.HeightProviders;
import minecraft.terrain.structure.ExtStructure;
import minecraft.terrain.structure.template.ExtStructureProcessor;
import minecraft.terrain.structure.template.JigsawPlacementContext;
import minecraft.terrain.structure.template.TemplatePool;
...
public class AronaClassRoom extends ExtStructure {
	...
	public AronaClassRoom(BootstrapContext<Structure> context) {
		super(Settings.of(
				Settings.validBiomes(context, ShittimChestBiomes.SHITTIM_CHEST_SEA_ID),
