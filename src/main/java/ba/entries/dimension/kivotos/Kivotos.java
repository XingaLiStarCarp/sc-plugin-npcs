...
import minecraft.terrain.DensityFunctionContext;
import minecraft.terrain.biome.ExtBiome;
import minecraft.terrain.decoration.Decoration;
import minecraft.terrain.decoration.TerrainDecorator;
import minecraft.terrain.decoration.TerrainTest;
...
public class Kivotos {
	...
	public static final EntryHolder<NoiseGeneratorSettings> NOISE_SETTINGS = ExtDimension.Noise.register(ID, (BootstrapContext<NoiseGeneratorSettings> context, RegistryAccess registryAccess) -> {
		DensityFunctionContext df = DensityFunctionContext.of(context);
