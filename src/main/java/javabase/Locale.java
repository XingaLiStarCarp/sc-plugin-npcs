...
public class Locale extends YamlConfig {
	...
	public Locale(String locale_folder, String file_type, String locale) {
		this(stack.get_caller_class(), locale_folder, file_type, locale);
	}

	public Locale(String locale_folder, String file_type) {
		this(stack.get_caller_class(), locale_folder, file_type);
	}

	public Locale(String locale) {
		this(stack.get_caller_class(), locale);
	}

	public Locale() {
		this(stack.get_caller_class());
	}
