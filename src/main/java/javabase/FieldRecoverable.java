...
public interface FieldRecoverable<Derived> extends Recoverable<Derived>, base<FieldRecoverable.References<Derived>> {
	...
	public class References<Derived> extends base.definition<FieldRecoverable<Derived>> implements Recoverable<Derived> {
