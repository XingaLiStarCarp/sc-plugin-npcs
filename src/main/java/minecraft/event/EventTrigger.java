 ...
 * 事件触发和执行器封装
 */
public interface EventTrigger<O> extends base<EventTrigger.Definition<O>> {
	 ...
	 * 事件触发动作定义
	 */
	class Definition<O> extends base.definition<EventTrigger<O>> {
