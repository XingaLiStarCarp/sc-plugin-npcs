...
import minecraft.core.registry.RegistryMap.BlockMap;
...
public class ExtBlock extends Block implements Localizable {
	 ...
	 * @return
	 */
	public static final <_Block extends Block> DeferredBlock<_Block> register(String name, Supplier<_Block> block, ExtCreativeTab creativeTab) {
		return BLOCKS.registerBlock(name, block, creativeTab);
	}

	public static final <_Block extends Block> DeferredBlock<_Block> register(String name, Supplier<_Block> block) {
	...
	public static final DeferredBlock<ExtBlock> register(String name, BlockBehaviour.Properties blockProperties, ExtCreativeTab creativeTab) {
		return register(name, () -> new ExtBlock(blockProperties), creativeTab);
	}
