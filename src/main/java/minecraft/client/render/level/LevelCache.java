...
public class LevelCache {
	...
	public static final Object2ObjectArrayMap<ColorResolver, BlockTintCache> getTintCaches(ClientLevel level) {
		return (Object2ObjectArrayMap<ColorResolver, BlockTintCache>) unsafe.read_member_reference(level, "tintCaches");
	}
	...
	public static final void setTintCaches(ClientLevel level, Object2ObjectArrayMap<ColorResolver, BlockTintCache> cache) {
		unsafe.write_member(level, "tintCaches", cache);
	}
	...
	public static final void updateColorResolverCache(ClientLevel level, ColorResolver grass, ColorResolver foliage, ColorResolver water) {
		...
		unsafe.write_static(BiomeColors.class, "GRASS_COLOR_RESOLVER", grass);// 该值实际上是索引cache的key，需要连同缓存一起修改
		unsafe.write_static(BiomeColors.class, "FOLIAGE_COLOR_RESOLVER", foliage);
		unsafe.write_static(BiomeColors.class, "WATER_COLOR_RESOLVER", water);
	}
}
