...
public class TesselatorInstance {
	...
	static {
		...
		Tesselator_begin = symbols.find_method(Tesselator.class, "begin", VertexFormat.Mode.class, VertexFormat.class);
		VertexConsumer_addvertex$FFF = symbols.find_method(VertexConsumer.class, "addVertex", float.class, float.class, float.class);
		VertexConsumer_addvertex$Matrix4f$FFF = symbols.find_method(VertexConsumer.class, "addVertex", Matrix4f.class, float.class, float.class, float.class);
		BufferBuilder_setUv = symbols.find_method(BufferBuilder.class, "setUv", float.class, float.class);

		VertexConsumer_setColor$FFFF = symbols.find_method(VertexConsumer.class, "setColor", float.class, float.class, float.class, float.class);
		BufferUploader_drawWithShader = symbols.find_method(BufferUploader.class, "drawWithShader", MeshData.class);
		BufferBuilder_buildOrThrow = symbols.find_method(BufferBuilder.class, "buildOrThrow");
	}
