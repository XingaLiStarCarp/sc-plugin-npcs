...
public class SceneGraphNode extends Node<String, VanillaRenderable.Instance> implements Renderable {
	 ...
	 * @param name
	 */
	protected SceneGraphNode(String name) {
		super(name);
	}

	protected SceneGraphNode(String name, VanillaRenderable.Instance renderable) {
		super(name, renderable);
	}

	protected SceneGraphNode(String name, Node<String, VanillaRenderable.Instance> parent) {
		super(name, parent);
	}
	...
	public final SceneGraphNode createNode(String path) {
		return (SceneGraphNode) this.findChildNode(parsePath(path), true, (String name, Node<String, VanillaRenderable.Instance> parent) -> {
	 ...
	 * @return
	 */
	public SceneGraphNode setUpdate(UpdateOperation preRenderOperation) {
