...
import minecraft.core.ModInit.Stage;
import minecraft.core.registry.MutableMappedRegistry;
import minecraft.core.registry.registries.server.DynamicRegistries;
...
public class Dimensions {
	...
	public static final void tickTime(ServerLevel level, boolean tick) {
		unsafe.write_member(level, "tickTime", tick);
	}
