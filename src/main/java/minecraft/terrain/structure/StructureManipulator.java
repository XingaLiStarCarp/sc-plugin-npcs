...
public class StructureManipulator {
	...
	static {
		...
		StructureTemplateManager_readStructure = symbols.find_method(StructureTemplateManager.class, "readStructure", InputStream.class);
	}
	...
	public static StructureTemplate loadStructureInJar(Class<?> targetJarCls, String inJarPath) {
		return loadStructure(file_system.resource_stream(targetJarCls, inJarPath));
	}

	public static StructureTemplate loadStructureInJar(String inJarPath) {
		return loadStructure(file_system.resource_stream(inJarPath));
	}
}
