package minecraft.terrain.structure;
...
import minecraft.core.registry.HolderSets;
import minecraft.core.registry.RegistryMap;
import minecraft.datagen.EntryHolder;
import minecraft.resources.ResourceKeys;
import minecraft.terrain.structure.template.JigsawPlacementContext;
import minecraft.terrain.structure.template.JigsawPlacementContext.StartPosResolver;
...
public abstract class ExtStructure extends Structure implements MapCodecHolder<Structure> {
	...
	public StructureType<?> type() {
		if (type == null) {
			reflection.class_operation.walk_fields(this.getClass(), DeferredHolder.class, StructureType.class, (Field f, boolean isStatic, DeferredHolder holder) -> {
